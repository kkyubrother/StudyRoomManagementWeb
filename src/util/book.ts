...
interface BookItemOnClick extends Omit<ServerBookData, "start_time" | "end_time">{
    start_time: moment.Moment
    end_time: moment.Moment

}

export const convertBookItem = (value: ServerBookData, book_date: number, onClick: (data: BookItemOnClick) => void) => {
    if (!moment(value.book_date).isSame(moment(book_date), "day"))
        return;
